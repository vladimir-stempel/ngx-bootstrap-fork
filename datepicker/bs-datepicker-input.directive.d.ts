...
export declare class BsDatepickerInputDirective implements ControlValueAccessor, Validator, OnInit, OnDestroy {
    ...
    onBlur(): void;
    hide(): void;
    static ɵfac: i0.ɵɵFactoryDef<BsDatepickerInputDirective, [{ host: true; }, null, null, null, null]>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<BsDatepickerInputDirective, "input[bsDatepicker]", never, {}, {}, never>;
}
