...
function MonthPickerComponent_table_0_tr_14_td_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function MonthPickerComponent_table_0_tr_14_td_1_Template_button_click_1_listener() { i0.ɵɵrestoreView(_r6); const dtz_r4 = ctx.$implicit; const ctx_r5 = i0.ɵɵnextContext(3); return ctx_r5.datePicker.select(dtz_r4.date); });
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction4(6, _c0, ctx_r3.isBs4 && !dtz_r4.selected && !ctx_r3.datePicker.isActive(dtz_r4), dtz_r4.selected || ctx_r3.isBs4 && !dtz_r4.selected && ctx_r3.datePicker.isActive(dtz_r4), dtz_r4.disabled, !ctx_r3.isBs4 && ctx_r3.datePicker.isActive(dtz_r4)))("disabled", dtz_r4.disabled);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction2(11, _c1, ctx_r3.isBs4 && dtz_r4.current, !ctx_r3.isBs4 && dtz_r4.current));
    i0.ɵɵadvance(1);
...
function MonthPickerComponent_table_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function MonthPickerComponent_table_0_Template_button_click_4_listener() { i0.ɵɵrestoreView(_r8); const ctx_r7 = i0.ɵɵnextContext(); return ctx_r7.datePicker.move(-1); });
    i0.ɵɵtext(5, "\u2039");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(6, "th");
    i0.ɵɵelementStart(7, "button", 3);
    i0.ɵɵlistener("click", function MonthPickerComponent_table_0_Template_button_click_7_listener() { i0.ɵɵrestoreView(_r8); const ctx_r9 = i0.ɵɵnextContext(); return ctx_r9.datePicker.toggleMode(0); });
    ...
    i0.ɵɵlistener("click", function MonthPickerComponent_table_0_Template_button_click_11_listener() { i0.ɵɵrestoreView(_r8); const ctx_r10 = i0.ɵɵnextContext(); return ctx_r10.datePicker.move(1); });
    i0.ɵɵtext(12, "\u203A");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("id", ctx_r0.datePicker.uniqueId + "-title")("disabled", ctx_r0.datePicker.datepickerMode === ctx_r0.maxMode)("ngClass", i0.ɵɵpureFunction1(6, _c2, ctx_r0.datePicker.datepickerMode === ctx_r0.maxMode));
    i0.ɵɵadvance(2);
...
MonthPickerComponent.ɵfac = function MonthPickerComponent_Factory(t) { return new (t || MonthPickerComponent)(i0.ɵɵdirectiveInject(i1.DatePickerInnerComponent)); };
