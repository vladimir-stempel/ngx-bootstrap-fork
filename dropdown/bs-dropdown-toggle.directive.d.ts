...
export declare class BsDropdownToggleDirective implements OnDestroy {
    ...
    onClick(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDef<BsDropdownToggleDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<BsDropdownToggleDirective, "[bsDropdownToggle],[dropdownToggle]", ["bs-dropdown-toggle"], {}, {}, never>;
}
