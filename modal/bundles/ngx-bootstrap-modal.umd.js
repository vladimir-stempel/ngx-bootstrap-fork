(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-bootstrap'] = global['ngx-bootstrap'] || {}, global['ngx-bootstrap'].modal = {}), global.ng.core, global.utils, global.i1, global.positioning));
}(this, (function (exports, i0, utils, i1, positioning) { 'use strict';
    ...
    BsModalRef.ɵprov = i0.ɵɵdefineInjectable({ token: BsModalRef, factory: BsModalRef.ɵfac });
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(BsModalRef, [{
                type: i0.Injectable
            }], null, null);
    })();
    ...
    ModalOptions.ɵprov = i0.ɵɵdefineInjectable({ token: ModalOptions, factory: ModalOptions.ɵfac });
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ModalOptions, [{
                type: i0.Injectable
            }], null, null);
    })();
    ...
    ModalContainerComponent.ɵfac = function ModalContainerComponent_Factory(t) { return new (t || ModalContainerComponent)(i0.ɵɵdirectiveInject(ModalOptions), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.Renderer2)); };
    ModalContainerComponent.ɵcmp = i0.ɵɵdefineComponent({ type: ModalContainerComponent, selectors: [["modal-container"]], hostAttrs: ["role", "dialog", "tabindex", "-1", 1, "modal"], hostVars: 3, hostBindings: function ModalContainerComponent_HostBindings(rf, ctx) {
            if (rf & 1) {
        ...
        }, ngContentSelectors: _c0, decls: 3, vars: 2, consts: [["role", "document"], [1, "modal-content"]], template: function ModalContainerComponent_Template(rf, ctx) {
            if (rf & 1) {
                i0.ɵɵprojectionDef();
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ModalContainerComponent, [{
                type: i0.Component,
                args: [{
            ...
            }], function () { return [{ type: ModalOptions }, { type: i0.ElementRef }, { type: i0.Renderer2 }]; }, { onClickStarted: [{
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ModalBackdropComponent, [{
                type: i0.Component,
                args: [{
    ...
    ModalDirective.ɵdir = i0.ɵɵdefineDirective({ type: ModalDirective, selectors: [["", "bsModal", ""]], hostBindings: function ModalDirective_HostBindings(rf, ctx) {
            if (rf & 1) {
    ...
    ***************************************************************************** */
    ...
    var BsModalService = /** @class */ (function () {
        ...
        BsModalService.prototype._showModal = function (content) {
            ...
            var modalContainerRef = modalLoader
                ...
                .to('body');
            bsModalRef.hide = function () { return modalContainerRef.instance.hide(); };
            bsModalRef.setClass = function (newClass) {
                modalContainerRef.instance.config.class = newClass;
            };
            bsModalRef.onHidden = new i0.EventEmitter();
            bsModalRef.onHide = new i0.EventEmitter();
        ...
        BsModalService.prototype._hideModal = function (id) {
            if (id != null) {
                var indexToRemove = this.loaders.findIndex(function (loader) { return loader.instance.config.id === id; });
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(BsModalService, [{
                type: i0.Injectable
            }], function () {
    ...
    var ModalModule = /** @class */ (function () {
        ...
        ModalModule.forRoot = function () {
            return {
                ...
                providers: [BsModalService, i1.ComponentLoaderFactory, positioning.PositioningService]
            };
        };
    ...
    (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(ModalModule, { declarations: [ModalBackdropComponent,
                ModalDirective,
